...
AInternationalBibleGameMode::AInternationalBibleGameMode()
{
	...
	IntenationalBibles.Add(TEXT("Afrikaans 1953 (1953)"));
	IntenationalBibles.Add(TEXT("Albanian"));
	IntenationalBibles.Add(TEXT("Tradução de João Ferreira de Almeida (Versão Revista e Atualizada)"));
	IntenationalBibles.Add(TEXT("Tradução de João Ferreira de Almeida Revista e Corrigida"));
	IntenationalBibles.Add(TEXT("American Standard Version (1901)"));
	IntenationalBibles.Add(TEXT("Bishops Bible (1568)"));
	IntenationalBibles.Add(TEXT("Bible Kralicka"));
	IntenationalBibles.Add(TEXT("Biblia Livre"));
	IntenationalBibles.Add(TEXT("Bungo-yaku: Taisho-kaiyaku (NT) (1950), Meiji-yaku (OT) (1953) (1950/1953)"));
	IntenationalBibles.Add(TEXT("Vietnamese Cadman (1934)"));
	IntenationalBibles.Add(TEXT("Chinese Union (Simplified)"));
	IntenationalBibles.Add(TEXT("Chinese Union (Traditional)"));
	IntenationalBibles.Add(TEXT("中文英皇钦定本上帝版 Chinese KJV (Simplified) Shang-Di 简体中文"));
	IntenationalBibles.Add(TEXT("中文英皇欽定本上帝版 Chinese KJV (Traditional) Shang-Di 繁體中文"));
	...
	IntenationalBibles.Add(TEXT("Finnish 1776 (Finnish) (1776)"));
	IntenationalBibles.Add(TEXT("Geneva Bible (1587)"));
	IntenationalBibles.Add(TEXT("Terjemahan Baru (1994)"));
	IntenationalBibles.Add(TEXT("Terjemahan Lama"));
	IntenationalBibles.Add(TEXT("Karoli"));
	IntenationalBibles.Add(TEXT("Authorized King James Version (1611 / 1769)"));
	IntenationalBibles.Add(TEXT("Kougo-yaku (1954/1955)"));
	IntenationalBibles.Add(TEXT("Luther Bible (1545) (1545)"));
	IntenationalBibles.Add(TEXT("Luther Bible (1912) (1912)"));
	IntenationalBibles.Add(TEXT("Maori Bible"));
	IntenationalBibles.Add(TEXT("Martin (1744)"));
	IntenationalBibles.Add(TEXT("NET Bible® (1996-2016)"));
	IntenationalBibles.Add(TEXT("Ostervald (1996)"));
	IntenationalBibles.Add(TEXT("NOWEJ BIBLII GDANSKIEJ (2012)"));
	IntenationalBibles.Add(TEXT("Uwspółcześniona Biblia Gdańska (2017)"));
	IntenationalBibles.Add(TEXT("Polska Biblia Gdanska (1881)"));
	IntenationalBibles.Add(TEXT("Reina Valera 1909 (1909)"));
	IntenationalBibles.Add(TEXT("Reina Valera Gómez (2010)"));
	IntenationalBibles.Add(TEXT("Reina Valera Gómez (2004) (2004)"));
	IntenationalBibles.Add(TEXT("Sagradas Escrituras (1569)"));
	...
	IntenationalBibles.Add(TEXT("Tyndale Bible"));
	IntenationalBibles.Add(TEXT("World English Bible (2006)"));
}
